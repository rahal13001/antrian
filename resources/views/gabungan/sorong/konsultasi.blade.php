                   ...
                   <div class="col-lg-8 entries">
                        ...
                        @if ($cekdata == 0)
                            <main id="main">
                                ...
                                <a href="/konsultasisorong" class="btn btn-danger text-center">Refresh</a>
                                @guest
                        ...
                        @auth
                        <form action="{{ route('status_sorong', $antrian->id) }}" method="POST" class="mt-3">
                            @method('put')
                            @csrf
                        ...
                        <div class="container mt-3 text-center">
                            <textarea id="my_text" cols="80" class="form-control">Nomor. Antrian. Konsultasi. SOQ. {{$antrian->no_urut }}</textarea>
                            <br>
