            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8 entries">
                    ...
                    <main id="main">
                        ...
                        <a href="/pelayananternate" class="btn btn-danger text-center">Refresh</a>
                        @guest
                    ...
                    <div class="container mt-3 text-center">
                        <textarea id="my_text" cols="100" class="form-control">Nomor. Antrian. Pelayanan. TTQ. {{$antrian->no_urut }}</textarea>
                        <br>
