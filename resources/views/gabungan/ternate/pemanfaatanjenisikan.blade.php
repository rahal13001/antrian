               ...
               <div class="col-lg-8 entries">
                    ...
                    @if ($cekdata == 0)
                        <main id="main">
                            ...
                            <h3 class="text-center">Pemanfaatan Jenis Ikan</h3>
                            <br>

                            <p class="text-center">Klik refresh untuk update data</p>
                            <div class="col text-center">
                            <a href="/pemanfaatanjenisikanternate" class="btn btn-danger text-center">Refresh</a>
                            @guest
                    ...
                    @guest
                        ...
                        <div class="col text-center">
                            <a href="#" class="btn btn-danger text-center">Refresh</a>
                    ...
                    <div class="container mt-3 text-center">
                        <textarea id="my_text" cols="80" class="form-control">Nomor. Antrian. Pemanfaatan, Jenis, Ikan. TTQ. {{$antrian->no_urut }}</textarea>
                        <br>
