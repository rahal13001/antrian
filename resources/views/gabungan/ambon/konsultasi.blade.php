            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <main id="main">
                        ...
                        <a href="/konsultasiambon" class="btn btn-danger text-center">Refresh</a>
                        @guest
                    ...
                    @auth
                    <form action="{{ route('status_ambon', $antrian->id) }}" method="POST">
                        @method('put')
                        @csrf
                    ...
                    <div class="container mt-3 text-center">
                        <textarea id="my_text" cols="100" class="form-control">Nomor. Antrian. Konsultasi. AMQ. {{$antrian->no_urut }}</textarea>
                        <br>
