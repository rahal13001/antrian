               ...
               <div class="col-lg-8 entries">
                    ...
                    @if ($cekdata == 0)
                        <main id="main">
                            ...
                            <a href="/pengaduanternate" class="btn btn-danger text-center">Refresh</a>
                            @guest
                    ...
                    <div class="container mt-3 text-center">
                        <textarea id="my_text" cols="80" class="form-control">Nomor. Antrian. Pengaduan. TTQ. {{$antrian->no_urut }}</textarea>
                        <br>
