        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row d-flex justify-content-center">
                   <div class="col-lg-8 entries">
                        ...
                        @auth
                        <form action="{{ route('status_ternate', $antrian->id) }}" method="POST" class="mt-3">
                            @method('put')
                            @csrf
                        ...
                        <div class="container mt-3 text-center">
                            <textarea id="my_text" cols="80" class="form-control">Nomor. Antrian. Konsultasi. TTQ. {{$antrian->no_urut }}</textarea>
                            <br>
