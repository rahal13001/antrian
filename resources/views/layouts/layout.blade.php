...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center bg-light" href="{{ route('admin_index') }}">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="{{ asset('img/teskkp.jpg') }}" alt="" class="img-responsive logo float-none !important" width="50vh">
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Antrian Merauke</a>
                        <a class="collapse-item" href="">Antrian Ambon</a>
                        <a class="collapse-item" href="">Antrian Ternate</a>
                        <a class="collapse-item" href="">Antrian Morotai</a>
                    </div>
                </div>
			</li>
