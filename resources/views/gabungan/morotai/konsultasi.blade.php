            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <main id="main">
                        ...
                        <a href="/konsultasimorotai" class="btn btn-danger text-center">Refresh</a>
                        @guest
                    ...
                    <div class="container mt-3 text-center">
                        <textarea id="my_text" cols="100" class="form-control">Nomor. Antrian. Konsultasi. OTI. {{$antrian->no_urut }}</textarea>
                        <br>
