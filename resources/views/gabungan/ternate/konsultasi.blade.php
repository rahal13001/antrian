            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <main id="main">
                        ...
                        <h3 class="text-center">Tidak ada Antrian Konsultasi</h3>
                        <br>

                        <p class="text-center">Klik refresh untuk update data</p>
                        <div class="col text-center">
                        <a href="/konsultasiternate" class="btn btn-danger text-center">Refresh</a>
                        @guest
                    ...
                    @auth
                    <form action="{{ route('status_ternate', $antrian->id) }}" method="POST">
                        @method('put')
                        @csrf
                            <input type="hidden" value="{{ $antrian->id }}" name="id">
                            <div class="col text-center">
                            <button class="btn btn-danger" name="tidak_adakonsultasi" type = 'submit' value="1">Tidak Ada</button>
                            <a href="#" hidden disabled class="button"></a>
                            <button class="btn btn-primary" name="adakonsultasi" type = 'submit' value="1">Ada</button>
                            </div>
                        </form>
                  
                    <div class="container mt-3 text-center">
                        <textarea id="my_text" cols="100" class="form-control">Nomor. Antrian. Konsultasi. TTQ. {{$antrian->no_urut }}</textarea>
                        <br>
